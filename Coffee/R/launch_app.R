...
#' It uses pre-processed survey data (`coffee_filtered`) to generate the visualizations.
#'
#' @details
#' When the `launch_app()` function is called, it loads and runs the Shiny app located
#' inside the package's "shinyapp" directory. The app includes inputs for selecting age group,
